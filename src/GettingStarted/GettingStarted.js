...
class GettingStarted extends React.Component {
    render() {
        return (
            <section className="main getstrt" id="getstrt">
                <h1>Usful</h1>
                <h2>Coronavirus resources are often filled with complex numbers and professional language that can be
                    overwhelming to the general public. USFUL is designed to offer easy to digest data and
